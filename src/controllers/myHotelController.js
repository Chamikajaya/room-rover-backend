...
exports.deleteHotel = exports.updateHotel = exports.getHotelById = exports.getAllMyHotels = exports.createHotel = exports.upload = void 0;
...
const updateHotel = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        // Update hotel data
        const updatedHotelFromDb = yield prisma.hotel.update({
            where: {
                id,
                userId,
            },
