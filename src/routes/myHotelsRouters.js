...
myHotelsRouter.put("/:id", validateCookie_1.validateCookie, myHotelController_1.upload.array("imageFiles", 5), myHotelController_1.updateHotel);
myHotelsRouter.get("/:hotelId", validateCookie_1.validateCookie, myHotelController_1.getHotelById);
myHotelsRouter.get("/", validateCookie_1.validateCookie, myHotelController_1.getAllMyHotels);
myHotelsRouter.delete("/:hotelId", validateCookie_1.validateCookie, myHotelController_1.deleteHotel);
